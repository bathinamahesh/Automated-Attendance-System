...
from .views import home_page, dash_board, inbox, profile, take_attendance, upload_assignment, profile, assignment_list, view_submissions, students_list, write_notice, change_password, faculty_time_table, confirm, profile_update, givemarks, detailattend,ml_model
...
urlpatterns = [
    ...
    path('faculty_upload_assignment/', upload_assignment,
     ...
     path('faculty_attendace_model/', ml_model,
         name="ml_model"),
